...
consent-NoClone-name = Disallow Paradox Anomaly / Changling
consent-NoClone-desc = Disallow yourself to be the target of a paradox anomaly clone or changling. (on = no copying)
